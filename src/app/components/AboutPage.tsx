...
export const AboutPage = ({ isDark }: { isDark?: boolean }) => {
  return (
    <Motion.div 
    ...
    >
      ...
      <div className="flex flex-col gap-[16px] h-full">
        ...
        <div className={`@container flex-1 relative rounded-[36px] w-full overflow-hidden ${isDark ? "bg-[#2C2C30]" : "bg-white"}`} data-name="Container">
