          ...
          <div className="flex flex-col items-center w-full h-full">
            <div className="content-stretch flex flex-col gap-[16px] items-center px-[min(32px,10cqmin)] py-[min(24px,8cqmin)] relative w-full h-auto md:h-full md:min-h-0">
              <div className="bg-[#f3f2f2] flex items-center justify-center px-[min(16px,5cqmin)] py-[min(8px,2.5cqmin)] relative rounded-full shrink-0" data-name="Link">
                <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#171717] text-[min(12px,4cqmin)] whitespace-nowrap tracking-[-0.15px]">About</p>
              </div>
              <div className="basis-auto md:basis-0 font-['Inter:Medium',sans-serif] font-medium grow leading-[0] min-h-0 not-italic overflow-visible md:overflow-y-auto relative text-[14px] text-black w-full">
